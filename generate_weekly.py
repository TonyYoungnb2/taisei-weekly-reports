...
<meta name="description" content="大誠株式会社专用不动產週報 {date_range}">
...
<header class="main-header">
  <div class="header-inner">
    ...
    <h1 class="main-title">大誠株式会社専用不动產週報</h1>
...
<footer class="main-footer">
  ...
  <p>Generated by 🦐 小虾 · {today_str} · 东京 · 大誠株式会社 専用</p>
</footer>
...
def main():
    ...
    if resp.status_code == 404:
        ...
        resp = github_api('POST', '/user/repos', {
            'name': REPO_NAME,
            'description': '大誠株式会社专用不动產週報 -- 東京不动產市場最新動向',
            'private': False,
            'auto_init': False,
        })
